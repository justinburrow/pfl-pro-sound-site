...
}`;function U(){const t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function D(){const t=visualViewport?.scale??1,e=visualViewport?.width??window.innerWidth,i=window.innerWidth-document.documentElement.clientWidth,o=t*e+i,r=outerWidth/o,s=Math.round(100*r);return s%5===0?s/100:s===33?1/3:s===67?2/3:s===133?4/3:r}const F=`
in vec2 v_objectUV;
...
`,x={maxColorCount:7},P=`#version 300 es
